 ...
 */
final class Version20240914190500 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coupon (id INT NOT NULL, code VARCHAR(255) NOT NULL, discount_type VARCHAR(255) NOT NULL, discount_value DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
